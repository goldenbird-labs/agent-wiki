...
export default function TopBar({ onOpenMobileMenu }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Search */}
      <div style={{ flex: 1, maxWidth: isMobile ? '100%' : '420px', position: 'relative' }}>
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
        ...
        >
          ...
          {!isMobile && <span style={{ fontSize: '13px', fontWeight: 600, color: '#fff', whiteSpace: 'nowrap' }}>AI Chat</span>}
        </button>
        ...
        {/* Avatar */}
        <div style={{ width: '34px', height: '34px', borderRadius: '50%', background: 'linear-gradient(135deg, #4F46E5, #7C3AED)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
